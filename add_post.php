...
<?php
include("./db.config/add_post.inc.php");
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="row pt-3">
                    <div class="image-post col-lg-5">
                        <label for="file-upload" class="custom-file-upload">
                            <img src="https://via.placeholder.com/400x300" alt="Upload image" id="previewImg">
                        </label>
                    ...
                    <div class="input-post col-lg-7">
                        <?php
                        ?>
                        <textarea name="caption-post" id="" rows="10" class="" placeholder="write a caption..." maxlength="300"></textarea>
                    </div>
                    <div class="all-post">
                        ...
                        <div class="hide-post d-flex align-items-center">
                            <label class="switch pt-2 pl-1 ml-2">
                                <input type="checkbox" name="hide_comment">
                                <span class="slider"></span>
                            </label>
